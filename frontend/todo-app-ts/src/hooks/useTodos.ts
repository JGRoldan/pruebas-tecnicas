...
import { fetchTodos, updateTodos } from "../services/todos.ts";
import type { TodoList, FilterValue } from "../types";
...
type Action =
  ...
  | { type: "COMPLETED"; payload: { id: string; done: boolean } }
...
export const useTodos = (): {
  ...
  handleCompleted: (id: string, done: boolean) => void;
  ...
  const handleCompleted = (id: string, done: boolean): void => {
